...
urlpatterns = [
    ...
    path('chat/', views.chat_view, name='chat_view'),  # View handling OpenAI responses
    path('chat_page/', views.chat_page, name='chat_page'),  # Page to render the chat interface
]
